...
/**
 * 617. Merge Two Binary Trees Title: Description: merge两个二叉树 Author:qincasin <qinjiaxing@shein.com>
 * Since:2019/6/11 10:27 Given two binary trees and imagine that when you put one of them to cover
 ...
 * \ 3   2                     1   3 /                           \   \ 5
 * 4   7 Output: Merged tree: 3 / \ 4   5 / \   \ 5   4   7
 *
 *
...
public class MergeTwoBinaryTrees {
  ...
  public static void main(String[] args) {
    ...
    mergeTwoBinaryTrees.mergeTrees(new TreeNode(10),new TreeNode(12));
